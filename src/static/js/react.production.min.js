...
(function (N, q) {
  ...
  function Q() {
    ...
    if ('function' === typeof n)
      if (
        ((n = { callback: n, priorityLevel: a, expirationTime: b, next: null, previous: null }),
        null === c)
      )
  ...
  function ea(a, b, d) {
    var g = void 0,
      ...
      e = null;
    if (null != b)
      for (g in (void 0 !== b.ref && (e = b.ref), void 0 !== b.key && (c = '' + b.key), b))
  ...
  function T(a, b, d, g) {
    ...
    if (Array.isArray(a))
      ...
      (null === a || 'object' !== typeof a
        ? (h = null)
        : ((h = (ka && a[ka]) || a['@@iterator']), (h = 'function' === typeof h ? h : null)),
      'function' === typeof h)
    )
    ...
    Array.isArray(a)
      ...
      : null != a &&
        (S(a) &&
          (a = ua(
            a,
            c + (!a.key || (b && b.key === a.key) ? '' : ('' + a.key).replace(la, '$&/') + '/') + d,
          )),
        g.push(a));
  }
